...
const campaignChapters = {
  ...
  frumo: [
    { id: "tax-of-tides", playableName: "Lafayette", opponentName: "Royal Tax Collector", title: "The Tax of the Tides", story: "King Ludvik's tribute fleets bleed Ristus while royal collectors seize treasure from every captain and family.", dialogue: ["Narrator: Before revolution had a flag, it had a ledger soaked in seawater.", "Tax Collector: By order of King Ludvik, every hold, net, vault, and table owes tribute.", "Lafayette: The sea gives enough for all Frumo. Your king has taught it to starve.", "Tax Collector: Then all Frumo can pay the king, and thank him for permission to sail.", "Lafayette: The tide is turning against your vaults."], endDialogue: ["Narrator: The tribute fleet breaks, and Ristus hears a sound older than royal law: captains refusing to kneel.", "Tax Collector: You have stolen from the crown.", "Lafayette: No. We returned what the crown stole first.", "Tax Collector: Ludvik will send ships enough to bury this harbor.", "Lafayette: Then the harbor will learn how many ships can sink." ] },
    { id: "voices-of-revolution", playableName: "Privateer Mirabeau", opponentName: "Royal Governor of Coral Bay", title: "Voices of Revolution", story: "Hidden taverns and pirate dens fill with reformers as Mirabeau, Danton, Marat, Robespier, and Lafayette demand a freer kingdom.", dialogue: ["Narrator: Taverns become chambers, pirate dens become assemblies, and every whispered complaint learns to become a speech.", "Mirabeau: A king who ignores his people will hear their cannons.", "Governor: Coral Bay answers only to Ludvik.", "Danton: Then Coral Bay will learn a new language.", "Lafayette: Let that language be freedom, not merely revenge."], endDialogue: ["Narrator: The first public oaths are sworn beneath lanterns, reef smoke, and the nervous silence of informers.", "Mirabeau: They heard us.", "Marat: Hearing is not enough. Fear must change sides.", "Lafayette: Careful. If fear leads us, we inherit Ludvik's throne in another shape.", "Danton: Then let courage lead, and let fear row behind it." ] },
    { id: "fall-of-silver-shoals", playableName: "Corsair Danton", opponentName: "General Carnot", title: "The Fall of Silver Shoals", story: "Revolutionary captains storm Ludvik's treasure fortress, proving common pirates can defeat royal formations.", dialogue: ["Narrator: Silver Shoals guards Ludvik's treasure and the story that royal stone cannot be breached by common hands.", "Danton: Silver Shoals was built to scare us.", "Carnot: It was built to contain you.", "Danton: Then watch what escapes.", "Carnot: Courage is loud until cannon fire teaches it discipline."], endDialogue: ["Narrator: The fortress falls, and every locked coin rings like a bell across the drowned markets of Ristus.", "Carnot: You have won a wall, not a war.", "Danton: Walls are where frightened kingdoms hide their truth.", "Marat: Open the vaults. Let the people see what hunger purchased.", "Danton: And let every captain know royal formations can bleed." ] },
    { id: "sunken-fortress", playableName: "Lafayette", opponentName: "King Ludvik", title: "The Sunken Fortress", story: "The capital floods with revolution as Ludvik discovers his treasure can buy armies, but not loyalty.", dialogue: ["Narrator: The capital floods with revolution, and Ludvik discovers that gold can hire soldiers but cannot command belief.", "Ludvik: You call it greed. I call it responsibility.", "Lafayette: Responsibility does not wear a jewel-covered crown.", "Ludvik: Do you know how difficult it is being king?", "Lafayette: No. But I know how easy you made suffering look."], endDialogue: ["Narrator: The palace gates open from the inside, because even royal guards have families beneath the tide.", "Ludvik: I was born to carry this kingdom.", "Lafayette: You mistook carrying for owning.", "Ludvik: Without me, you will devour each other.", "Lafayette: Then our first free act will be proving you wrong." ] },
    { id: "trial-of-king", playableName: "Robespier", opponentName: "Royal Loyalists", title: "The Trial of the King", story: "The monarchy falls, but Frumo divides over whether Ludvik should be imprisoned, spared, or executed.", dialogue: ["Narrator: With Ludvik chained, the revolution faces a question no victory can answer cleanly.", "Robespier: No kingdom can be free while the crown still lives.", "Lafayette: Justice is not hunger with a blade.", "Royal Loyalist: Harm the king and every old fleet will call you murderers.", "Robespier: Mercy is how tyrants learn to swim back."], endDialogue: ["Narrator: The verdict divides the republic before it has even learned to stand.", "Lafayette: We have made the crown mortal. That should have been enough.", "Robespier: Enough is the word cautious men use when courage becomes expensive.", "Marat: The people wanted certainty. We gave them a sentence.", "Lafayette: Sentences echo longer than cheers." ] },
    { id: "reign-of-revolution", playableName: "Marat", opponentName: "Robespier the Red Tide", title: "The Reign of the Revolution", story: "Victory curdles into suspicion as Robespier hunts enemies of freedom until the revolution itself becomes dangerous.", dialogue: ["Narrator: Victory curdles into suspicion, and the revolution begins searching its own reflection for enemies.", "Robespier: The enemies of freedom wear many faces.", "Marat: Then you will soon accuse the mirror.", "Robespier: Mercy is the weapon of tyrants.", "Marat: And purity is the mask fear wears when it wants a judge's chair."], endDialogue: ["Narrator: The Red Tide recedes, leaving names, warrants, and frightened silence caught in the coral.", "Robespier: I kept the republic clean.", "Marat: You scrubbed it until it bled.", "Lafayette: Freedom cannot survive if every disagreement becomes treason.", "Marat: Then write that down before the next savior forgets." ] },
    { id: "hero-of-republic", playableName: "Polea", opponentName: "Admiral of the Northern Coalition", title: "The Hero of the Republic", story: "As chaos spreads, Polea wins impossible naval battles, defeats Frumo-world invaders, and gives the republic hope.", dialogue: ["Narrator: Coalition sails crowd the horizon, and the wounded republic discovers how quickly fear can ask for a hero.", "Polea: I did not come to rule the republic.", "Admiral: No. You came to make it need you.", "Polea: Today it needs victory.", "Admiral: Tomorrow it will need permission."], endDialogue: ["Narrator: Polea wins the impossible battle, and the republic chants his name with gratitude and relief.", "Admiral: You have saved them. That is the dangerous part.", "Polea: Saving a people should not sound like accusation.", "Lafayette: It does when they begin mistaking one captain for the sea.", "Polea: Then let them remember the sea brought me here." ] },
    { id: "lord-commander", playableName: "Polea", opponentName: "Council Rivals", title: "Lord Commander", story: "Polea saves the republic, then takes control of it as the Council of Captains yields more power each year.", dialogue: ["Narrator: Each emergency passes, but the authority granted to survive it remains in Polea's hands.", "Councilor: You were given command for one crisis.", "Polea: The crisis learned to change names.", "Councilor: So did ambition.", "Polea: Ambition built the fleet you now hide behind."], endDialogue: ["Narrator: The Council yields a little more power and tells itself survival is not surrender.", "Councilor: You have made obedience feel practical.", "Polea: I have made disorder answerable.", "Lafayette: A republic should be slower than a warship.", "Polea: Slow ships sink when storms stop waiting." ] },
    { id: "frumo-empire", playableName: "Polea", opponentName: "Polea's Shadow", title: "The Frumo Empire", story: "Polea crowns himself Lord Commander of All Frumo: no king, no council, no election, only command.", dialogue: ["Narrator: Polea crowns himself without calling it a crown, and the republic learns how command can dress as necessity.", "Polea: I freed the Frumo from kings.", "Shadow: And gave them a commander instead.", "Polea: Better one helm than a thousand drowning hands.", "Shadow: Say it plainly. You trust the people only after they obey."], endDialogue: ["Narrator: The banners change, the fleets expand, and citizens argue whether empire is betrayal or the price of order.", "Polea: I have united what councils nearly drowned.", "Shadow: You have mistaken still water for peace.", "Polea: History will remember strength.", "Shadow: History remembers chains too, especially when they shine." ] },
    { id: "hundred-fleets", playableName: "Polea", opponentName: "The Coral Crown, Kelpbound Princes, and Brasswater League", title: "The Hundred Fleets", story: "Polea's armadas dominate Reath's oceans as rival Frumo sea powers unite against his endless victories.", dialogue: ["Narrator: Rival sea powers unite, not because they agree with each other, but because Polea has taught them what fear shares.", "Coral Envoy: The seas do not belong to one captain.", "Polea: Then why do they answer mine?", "Brasswater Admiral: Because fear sounds like obedience.", "Polea: Fear is only the first lesson. Order is the second."], endDialogue: ["Narrator: The hundred fleets scatter, and Polea's map grows wider than any Frumo ruler has held.", "Coral Envoy: You win waters faster than you can know them.", "Polea: I do not need to know every wave to command the tide.", "Brasswater Admiral: That is why the tide will hate you.", "Polea: Hatred still moves around a strong enough hull." ] },
    { id: "frozen-sea", playableName: "Polea", opponentName: "The Ice Leviathan", title: "The Frozen Sea", story: "Polea attempts to conquer the northern oceans, but storms, ice, hunger, and a leviathan shatter the once-invincible navy.", dialogue: ["Narrator: Polea sails north to conquer the only ocean that has never learned his name.", "Polea: No tide has ever refused me.", "Ice Leviathan: This is not tide. This is silence.", "Polea: Then I will break silence too.", "Ice Leviathan: Command freezes before it reaches me."], endDialogue: ["Narrator: The northern fleet shatters, and for the first time Polea returns with fewer ships than excuses.", "Polea: Storms are accidents. Ice is weather. Hunger is logistics.", "Ice Leviathan: Name your defeat smaller if it comforts you.", "Lafayette: The sea finally answered without applause.", "Polea: No. It merely delayed the next voyage." ] },
    { id: "last-tide", playableName: "The Restored Council", opponentName: "Lord Commander Polea", title: "The Last Tide", story: "Former allies and rival fleets face Polea one final time, then restore the Council with the uneasy knowledge that freedom can decay again.", dialogue: ["Narrator: Former allies gather with rival fleets, and the last battle asks whether Frumo can survive its greatest hero.", "Polea: I freed the Frumo. I united them. I made them strong.", "Lafayette: And then you made them yours.", "Polea: If that makes me a tyrant, history may judge me.", "Councilor: The living will judge first."], endDialogue: ["Narrator: Polea falls, but no one celebrates for long. The republic has learned what fear can build from gratitude.", "Lafayette: Restore the Council. Restore the arguments. Restore the burden of choice.", "Councilor: And if another crisis asks for one hand on the helm?", "Lafayette: Then remember how easily a hand becomes a fist.", "Polea: Perhaps history will still understand me. Perhaps that is punishment enough." ] }
  ],
  bizi: [
