...
const campaignChapters = {
  rumin: [
    ...
    { id: "the-jewel", playableName: "Kaiser", opponentName: "Corrupt Governor Severan", title: "The Jewel", story: "Kaiser rises as a beloved officer who walks among workers, pays debts, and exposes a governor protected by the aristocracy.", dialogue: ["Narrator: Kaiser rises as a soldier of the people, paying debts the Senate pretends not to see.", "Severan: You mistake popularity for authority.", "Kaiser: No. I mistake theft for treason.", "Severan: The people cheer anyone who promises them bread.", "Kaiser: Then perhaps you should have fed them."], endDialogue: ["Narrator: Severan falls, and Kaiser becomes the Jewel of Rumie.", "Crowd: Kaiser! Kaiser! Kaiser!", "Severan: They will love you until you ask something of them.", "Kaiser: Then I will ask only what Rumie needs.", "Severan: That is how every tyrant introduces himself."] },
    { id: "gaulic-wars", playableName: "Kaiser", opponentName: "Gaulic Warchief Vercan", title: "The Gaulic Wars", story: "Northern tribes unite against Rumie. Kaiser turns frontier war into fame, wealth, and open trade routes.", dialogue: ["Narrator: The northern frontier burns, and Kaiser marches toward the war that will make his name too large for the Senate.", "Vercan: Your roads end here, jewel prince.", "Kaiser: Roads do not end. They arrive.", "Vercan: Then arrive with steel.", "Kaiser: I brought more than steel. I brought Rumie."], endDialogue: ["Narrator: The frontier opens, and Kaiser returns with veterans, wealth, and a legend the Senate cannot easily command.", "Vercan: You win land. You do not win memory.", "Kaiser: Memory follows roads too.", "Vercan: Then one day your empire will remember every place it wounded.", "Kaiser: And every place it raised from ruin."] },
    { id: "three-runes", playableName: "Kaiser", opponentName: "Ancient Rune Guardian", title: "The Three Runes", story: "Kaiser discovers vaults of Strength, Protection, and Experience, then begins binding sacred runes to the legions.", dialogue: ["Narrator: Beneath conquered lands, Kaiser finds vaults older than Rumie itself.", "Guardian: Strength without wisdom breaks itself.", "Kaiser: Then I will take wisdom too.", "Guardian: All conquerors say that before the vault closes.", "Kaiser: I am not here to conquer the runes. I am here to make Rumie worthy of them."], endDialogue: ["Narrator: The runes answer Kaiser, and Rumie's legions become more than soldiers.", "Guardian: You have taken Strength. You have taken Protection. You have taken Experience.", "Kaiser: Then Rumie will endure.", "Guardian: No. Rumie will become harder to kill.", "Kaiser: For an empire, that may be the same thing."] },
    { id: "first-empire-bank", playableName: "Kaiser", opponentName: "Market Collapse", title: "The First Empire Bank", story: "Kaiser returns to build roads, grain systems, public works, and banking reforms while saboteurs try to break Rumie's markets.", dialogue: ["Narrator: Kaiser turns from conquest to reform, but money resists command as fiercely as armies do.", "Merchant: The city eats because credit moves.", "Brutus: And if one man commands the credit?", "Kaiser: Then one man answers if the people starve.", "Brutus: Or one man decides who deserves bread."], endDialogue: ["Narrator: The markets hold, and the people begin trusting Kaiser more than the Republic itself.", "Merchant: The grain arrives. The banks open. The streets are calm.", "Brutus: Calm is not the same as free.", "Kaiser: Hunger is not freedom either.", "Brutus: No. But a fed people may still wake in chains."] },
    { id: "the-crossing", playableName: "Kaiser", opponentName: "Senate General Cassius", title: "The Crossing", story: "The Senate orders Kaiser to surrender command. Brutus pleads for restraint, but Kaiser marches and civil war begins.", dialogue: ["Narrator: The Senate orders Kaiser to surrender command. Between law and loyalty, Rumie holds its breath.", "Brutus: Kaiser, do not do this.", "Kaiser: If I surrender, Rumie returns to corruption.", "Brutus: Then save the Republic.", "Kaiser: I intend to.", "Brutus: You cannot save a thing by standing above it."], endDialogue: ["Narrator: Kaiser crosses the line, and the Republic becomes a battlefield.", "Cassius: You have declared war on Rumie.", "Kaiser: I have declared war on the men who sold it.", "Brutus: You crossed with soldiers, not arguments.", "Kaiser: Arguments failed the hungry. Soldiers will not."] },
    { id: "last-republic", playableName: "Kaiser", opponentName: "Brutus", title: "The Last Republic", story: "Rumie burns as legions and senators collide. Kaiser wins the city, but Brutus survives the fall of the old order.", dialogue: ["Narrator: The old order makes its final stand, and Brutus faces the man he once hoped would save it.", "Brutus: You have saved Rumie by conquering it.", "Kaiser: I have saved Rumie from men who sold it.", "Brutus: Then we are both traitors.", "Kaiser: Perhaps. But only one of us is still useful."], endDialogue: ["Narrator: The Republic still speaks, but it no longer rules.", "Brutus: Listen to the silence after victory.", "Kaiser: I hear rebuilding.", "Brutus: I hear fear learning to applaud.", "Kaiser: Then teach it courage, Brutus. Do not ask me to restore cowardice."] },
    { id: "emperor-of-gold", playableName: "Kaiser", opponentName: "Rebel Senate Coalition", title: "Emperor of Gold", story: "At Kaiser's peak, roads, banks, and legions flourish, but prisoners, taxes, and central rule make citizens question the jewel.", dialogue: ["Narrator: Rumie prospers beneath Kaiser, but gold can gild a cage as easily as a crown.", "Senator: Prosperity is not freedom.", "Kaiser: Freedom without bread is a slogan.", "Brutus: And bread without law is obedience.", "Kaiser: Law failed when it served only those who could purchase it."], endDialogue: ["Narrator: Kaiser reaches the height of power, and Rumie begins to wonder whether rescue has become rule.", "Senator: The roads are full. The banks are strong. The prisons are fuller.", "Kaiser: Order has a cost.", "Brutus: You once called that cost theft.", "Kaiser: I was younger then.", "Brutus: No. You were clearer."] },
    { id: "ides-of-rumie", playableName: "Kaiser", opponentName: "Brutus and the Conspirators", title: "The Ides of Rumie", story: "Kaiser stabilizes the empire, yet the conspiracy reaches the Senate floor. This chapter frames the tragedy more than the victory.", dialogue: ["Narrator: The conspiracy reaches the Senate floor, where gratitude, fear, and betrayal wear the same robes.", "Kaiser: You too, Brutus?", "Brutus: I do this for Rumie.", "Kaiser: No. You do it because Rumie no longer needs you.", "Brutus: I do it because Rumie should need no one man."], endDialogue: ["Narrator: Kaiser falls, but the empire does not. His killers destroy the man and preserve the myth.", "Brutus: It is done.", "Conspirator: Then why are they not cheering?", "Brutus: Because they loved him.", "Conspirator: And now?", "Brutus: Now they will remember him better than he was."] },
    { id: "war-of-successors", playableName: "Bobei", opponentName: "Brutus", title: "War of the Successors", story: "After Kaiser dies, Bobei seeks vengeance while Brutus tries to restore the Republic from the ruins.", dialogue: ["Narrator: Kaiser's death leaves Rumie with grief, ambition, and armies looking for a name to follow.", "Bobei: You killed a man and woke an empire.", "Brutus: I killed a tyrant.", "Bobei: Then why does Rumie weep?", "Brutus: Because grief is easier than liberty."], endDialogue: ["Narrator: Brutus loses the future, and the Republic becomes a memory carried by the empire that replaces it.", "Brutus: I wanted Rumie to stand without a master.", "Bobei: You left it leaderless in a storm.", "Brutus: And you would give it another master?", "Bobei: I would give it an heir.", "Brutus: Then Kaiser wins, even dead."] },
    { id: "first-emperor", playableName: "Augustus", opponentName: "Bobei the Great", title: "The First Emperor", story: "Augustus defeats Bobei, keeps the bank, legions, and rune program, restores Senate traditions, and leaves Rumie with an empire wearing republican robes.", dialogue: ["Narrator: Augustus and Bobei clash over Kaiser's legacy: vengeance or settlement, sword or law.", "Bobei: I was Kaiser's sword.", "Augustus: And I will be his law.", "Bobei: Law without fire is parchment.", "Augustus: Fire without law is only smoke.", "Old Senator: Perhaps the better question is whether Rumie could have survived without him."], endDialogue: ["Narrator: Augustus wins. The Senate returns in ceremony, the empire remains in fact, and Rumie learns to call obedience tradition.", "Bobei: You kept the Senate's masks.", "Augustus: People fear naked power.", "Old Senator: And what should we call this new arrangement?", "Augustus: Peace.", "Bobei: Empire.", "Augustus: In Rumie, they will learn to mean the same thing."] }
  ],
  sheen: [
